...
window.Modernizr = function (e, t, n) {
    ...
    var r = "2.8.3", i = {}, s = !0, o = t.documentElement, u = "modernizr", a = t.createElement(u), f = a.style, l, c = {}.toString, h = " -webkit- -moz- -o- -ms- ".split(" "), p = "Webkit Moz O ms", d = p.split(" "), v = p.toLowerCase().split(" "), m = {svg: "http://www.w3.org/2000/svg"}, g = {}, y = {}, b = {}, w = [], E = w.slice, S, x = function (e, n, r, i) {
    ...
    !L(T, "undefined") && !L(T.call, "undefined") ? N = function (e, t) {
        ...
        return k("opacity:.55"), /^0.55$/.test(f.opacity)
    ...
    return i.addTest = function (e, t) {
        ...
        return O([e])
    }, i.testAllProps = _, i.testStyles = x, o.className = o.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (s ? " js " + w.join(" ") : ""), i
